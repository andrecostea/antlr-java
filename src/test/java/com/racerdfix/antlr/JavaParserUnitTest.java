...
public class JavaParserUnitTest {
    ...
    @Test
    public void whenOneMethodStartsWithUpperCase_thenOneErrorReturned3() throws Exception{

        String javaClassContent = "public class SampleClass { void DoSomething(){} void doSomethingElse(){} }";
